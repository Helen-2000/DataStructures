...
public class Grafica<T> implements Coleccion<T> {
    ...
    @Override public void agrega(T elemento) {
      ...
      vertices.agrega(elemento, (Vertice)vertice(elemento));
    }
    ...
    public void desconecta(T a, T b) {
        ...
        va.vecinos.elimina(vecA_B.get());
        vb.vecinos.elimina(vecB_A.get());
        aristas--;
    }
    ...
    public Lista<VerticeGrafica<T>> dijkstra(T origen, T destino) {
      if(!contiene(origen) || !contiene(destino))
        throw new NoSuchElementException();
      Lista<VerticeGrafica<T>> lista = new Lista<VerticeGrafica<T>>();
      MonticuloMinimo<Vertice> monticuloMinimo = new MonticuloMinimo<Vertice>(vertices, vertices.getElementos());
